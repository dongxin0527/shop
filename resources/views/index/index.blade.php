...
@section('content')
    ...
    <div class="slider">
        ...
        <ul class="slides">
            <li>
                <img src="/shop/index/img/slide1.jpg" alt="">
            ...
            <li>
                <img src="/shop/index/img/slide2.jpg" alt="">
                <div class="caption slider-content center-align">
            ...
            <li>
                <img src="/shop/index/img/slide3.jpg" alt="">
                <div class="caption slider-content center-align">
                    <h2>FASHION SHOP</h2>
                    <h4>Lorem ipsum dolor sit amet.</h4>
                    <a href="" class="btn button-default">SHOP NOW</a>
            ...
            <div class="row">
                ...
                <div class="col s6">
                    <div class="content">
                        ...
                        <a class="btn button-default"  href="{{url('index/Goods/product')}}?id={{$v->goods_id}}">ADD TO CART</a>
                    </div>
                </div>
                @endforeach
            </div>
